  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-20 left-20 w-72 h-72 bg-tech-blue/20 rounded-full blur-3xl animate-float"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
              ...
              <span className="bg-gradient-to-r from-tech-blue to-cyber-glow bg-clip-text text-transparent animate-gradient-shift bg-300%">
                BOT
              </span>
            </h1>
            ...
            <div className="flex items-center gap-8 pt-8">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-tech-blue">IA</div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-tech-blue/20 to-cyber-glow/20 blur-3xl transform scale-110"></div>
            <img 
              src={salesbotHero} 
              alt="SalesBot - Robô de Vendas com Inteligência Artificial"
              className="relative z-10 w-full h-auto rounded-2xl shadow-2xl border border-tech-blue/20"
            />
          </div>
        </div>
      </div>
