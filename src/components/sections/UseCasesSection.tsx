      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {useCases.map((useCase, index) => (
            <Card key={index} className="group p-8 bg-card/50 backdrop-blur border-border/50 hover:border-tech-blue/50 hover:shadow-lg hover:shadow-tech-blue/10 transition-all duration-300 cursor-pointer">
              <div className="mb-6">
        ...
        <div className="mt-16 text-center">
          <Card className="inline-block p-8 bg-gradient-to-r from-tech-blue/10 to-cyber-glow/10 border-tech-blue/30">
